...
workspace_name = "dio-mlexercise" # PLACEHOLDER
subscription_id = "08f562e5-6306-45a8-a9e0-7a086357d587" # PLACEHOLDER
resource_group = "dio-mlexercise" # PLACEHOLDER
experiment_name = "Default" # PLACEHOLDER
iteration = "8"  # PLACEHOLDER
run_id = "honest_root_2hbmz9nh4w_8"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/Default','subscription_id':'08f562e5-6306-45a8-a9e0-7a086357d587','resource_group':'dio-mlexercise','workspace_name':'dio-mlexercise','iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':30,'enforce_time_on_windows':False,'experiment_timeout_minutes':360,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':None,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':False,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'minimize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_DS11_v2','vm_priority':'dedicated','label_column_name':'Revenue','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": true, \"with_std\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"ElasticNet\", \"module\": \"sklearn.linear_model\", \"param_args\": [], \"param_kwargs\": {\"alpha\": 0.001, \"l1_ratio\": 1}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"4379608887dc335ce8c4ec4afbec7da03177d166\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, ElasticNet }\"}" # PLACEHOLDER
pipeline_id = "4379608887dc335ce8c4ec4afbec7da03177d166" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/westcentralus/workspaces/562445ed-49b9-4637-9803-6a0fef0d27c6/data/dio-icecream-data/versions/1\",\"ResolvedUri\":\"azureml://locations/westcentralus/workspaces/562445ed-49b9-4637-9803-6a0fef0d27c6/data/dio-icecream-data/versions/1\",\"AssetId\":\"azureml://locations/westcentralus/workspaces/562445ed-49b9-4637-9803-6a0fef0d27c6/data/dio-icecream-data/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
